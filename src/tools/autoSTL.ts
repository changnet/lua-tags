...
const stl = [
    ...
    },
    {
        v: '5.4',
        j: 'stl/stl_5.4.json',
        c: 'stl/doc_5_4/contents.html',
        m: 'stl/doc_5_4/manual.html',
    },
    {
        v: '5.5',
        j: 'stl/stl_5.5.json',
        c: 'stl/doc_5_5/contents.html',
        m: 'stl/doc_5_5/manual.html',
    },
];
...
function searchSymbol(ctx: string) {
    ...
    lines.forEach((line) => {
        ...
        matchs = line.match(/^<A HREF="manual.html#pdf-(.+?)">(.+?)<\/A><BR>$/);
        if (matchs && 'basic' !== matchs[2]) {
            symbols.push({
                name: matchs[2],
                url: matchs[1],
